...
// =============================================
// CRITICAL: ADD THESE MISSING ADMIN ROUTES
// =============================================
$router->add('GET', 'admin/doctors/schedule/{id}', 'AdminController', 'doctorSchedule', ['AuthMiddleware', 'AdminMiddleware']);
$router->add('GET', 'admin/doctors/appointments/{id}', 'AdminController', 'doctorAppointments', ['AuthMiddleware', 'AdminMiddleware']);
$router->add('POST', 'admin/delete-doctor/{id}', 'AdminController', 'deleteDoctor', ['AuthMiddleware', 'AdminMiddleware']);
