...
<section class="hero-section">
    <div class="container">
        ...
        <p class="lead">Edit department information</p>
    </div>
</section>
        ...
        <div class="col-md-8 mx-auto">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0"><i class="fas fa-edit me-2"></i>Edit Department: <?php echo htmlspecialchars($department['department_name']); ?></h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="<?php echo BASE_URL; ?>admin/departments/edit/<?php echo $department['id']; ?>">
                        <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="floor_number" name="floor_number" 
                                       value="<?php echo htmlspecialchars($department['floor_number'] ?? ''); ?>">
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="extension_number" name="extension_number" 
                                       value="<?php echo htmlspecialchars($department['extension_number'] ?? ''); ?>">
                            </div>
                        </div>
                            ...
                            <select class="form-select" id="head_doctor_id" name="head_doctor_id">
                                ...
                                <?php foreach ($doctors as $doctor): ?>
                                    <option value="<?php echo $doctor['id']; ?>" 
                                            <?php echo ($department['head_doctor_id'] ?? '') == $doctor['id'] ? 'selected' : ''; ?>>
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="is_active" name="is_active" value="1"
                                       <?php echo $department['is_active'] ? 'checked' : ''; ?>>
